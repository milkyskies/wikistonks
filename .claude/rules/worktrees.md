...
Worktrees live at `../wikistonks-worktrees/<issue-num>/` relative to the repo root.

```
~/Code/Projects/
├── wikistonks/                # main repo (stay on main here)
└── wikistonks-worktrees/
...
git worktree add ../wikistonks-worktrees/<num> -b feature/#<num>.<summary> main

# All work happens inside the worktree
cd ../wikistonks-worktrees/<num>
```
...
git worktree add ../wikistonks-worktrees/<epic-num> -b feature/#<epic-num>.<summary> main
cd ../wikistonks-worktrees/<epic-num>

# Sub-issue: branch off the epic branch
git worktree add ../wikistonks-worktrees/<sub-num> -b feature/#<epic-num>/#<sub-num>.<summary> feature/#<epic-num>.<summary>
cd ../wikistonks-worktrees/<sub-num>
```
...
```bash
pwd   # must be .../wikistonks-worktrees/<num>
...
```bash
git worktree remove ../wikistonks-worktrees/<num>
```
...
- **Never enter another agent's worktree directory.** If `../wikistonks-worktrees/<num>` already exists, another agent owns that issue — pick something else.
